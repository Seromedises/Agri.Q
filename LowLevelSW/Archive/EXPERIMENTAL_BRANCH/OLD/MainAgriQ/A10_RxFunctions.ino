...
void rx_J1updown(){
    if(digitalRead(AgriQJoyRx.PIN_J1updwn)){
      ...
      AgriQJoyRx.VALUE_J1updwn = (uint16_t) (0.6*(micros() - AgriQJoyRx.timer_J1updwn) + 0.4*AgriQJoyRx.VALUE_J1updwn);
    } 
  }
...
void rx_J1leftright(){
    if(digitalRead(AgriQJoyRx.PIN_J1leftright)){
      ...
      AgriQJoyRx.VALUE_J1leftright = (uint16_t) (0.6*(micros() - AgriQJoyRx.timer_J1leftright) + 0.4*AgriQJoyRx.VALUE_J1leftright);
    }
  }
